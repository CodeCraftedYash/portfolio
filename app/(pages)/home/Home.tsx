...
import ResumeDownloadButton from '@/app/components/ui/ResumeDownloadButton';

function HomePage() {
  const titleText:string ="Hi I am Yash Mishra";
  const titleText2:string = "a Web Developer";
  return (
    <div className='w-full min-h-screen flex flex-col flex-nowrap gap-20 sm:gap-20 '>{/**page container */}
